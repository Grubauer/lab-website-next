...
export function AnimatedPhoneProject({project, img_count, onPhoneHovered, canvasId})
{
    ...
    return <AnimationContainer >
        <PhoneAnimation onTouchStart={() => setHovered(true)} onTouchCanceled={() => setHovered(false)} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} canvasId={canvasId} activeProject={activeProject} />
