...
import BigLabLogo from "../components/Graphics/FullLabLogo";

export default function Impressum(){
    return <div>
        <div className="container" style={{textAlign: "justify", lineBreak: "anywhere", paddingTop: "6rem"}}>
            <h1 className="adsimple-121612556">Impressum</h1>
            <p className="adsimple-121612556">Informationspflicht laut §5 E-Commerce Gesetz, §14 Unternehmensgesetzbuch,
                §63 Gewerbeordnung und Offenlegungspflicht laut §25 Mediengesetz.</p>
            <p className="adsimple-121612556">lab73 e.U.<br/>Paul Wiesinger<br/>Hatscheksiedlung 7, <br/>4680 Haag am
                Hausruck, <br/>Österreich</p>
            <p className="adsimple-121612556">
                <strong>Unternehmensgegenstand:</strong> Dienstleistungen in der Informationstechnologie und
                Automatischen Datenverarbeitung<br/>
                <strong>Firmenbuchnummer:</strong> 540111 g<br/>
                <strong>Firmenbuchgericht:</strong> 4600 Wels<br/>
                <strong>Firmensitz:</strong> 4680 Haag am Hausruck</p>
            <p className="adsimple-121612556">
                <strong>Tel.:</strong> 0650/3702288<br/>
                <strong>E-Mail:</strong> <a href="mailto:office@lab73.at">office@lab73.at</a>
            </p>
            <p className="adsimple-121612556">
                <strong>Mitglied bei:</strong> WKO<br/>
                <strong>Berufsrecht:</strong> Gewerbeordnung: www.ris.bka.gv.at</p>
            <p className="adsimple-121612556">
                <strong>Aufsichtsbehörde/Gewerbebehörde:</strong> Bezirkshauptmannschaft Grieskirchen-Eferding<br/>
            ...
            <h2 id="haftung-fuer-inhalte-dieser-webseite" className="adsimple-121612556">Haftung für Inhalte dieser
                Webseite</h2>
            ...
            <h2 id="haftung-links-webseite" className="adsimple-121612556">Haftung für Links auf dieser Webseite</h2>
            ...
            <h2 id="urheberrechtshinweis" className="adsimple-121612556">Urheberrechtshinweis</h2>
            ...
            <p>Sollten Sie auf dieser Webseite Inhalte finden, die das Urheberrecht verletzen, bitten wir Sie uns zu
                kontaktieren.</p>
            <h2 id="bildernachweis" className="adsimple-121612556">Bildernachweis</h2>
            <p>Die Bilder, Fotos und Grafiken auf dieser Webseite sind urheberrechtlich geschützt.</p>
            <p>Die Bilderrechte liegen (sofern nicht anders angegeben) bei den folgenden Fotografen und Unternehmen:</p>
            <ul className="adsimple-121612556">
                <li className="adsimple-121612556">lab73 e.U.</li>
            </ul>
            <h1 className="adsimple-121612556">Datenschutzerklärung</h1>
            ...
            <ul>
                ...
                <li>
                    <a href="#eingebettete-social-media-elemente-datenschutzerklaerung">Eingebettete Social Media
                        Elemente Datenschutzerklärung</a>
                </li>
                <li>
                    <a href="#jquery-cdn-datenschutzerklaerung">jQuery CDN Datenschutzerklärung</a>
                </li>
            </ul>
            <h2 id="datenschutz" className="adsimple-121612556">Datenschutz</h2>
            ...
            <h2 id="automatische-datenspeicherung" className="adsimple-121612556">Automatische Datenspeicherung</h2>
            ...
            <ul className="adsimple-121612556">
                <li className="adsimple-121612556">die Adresse (URL) der aufgerufenen Webseite</li>
                <li className="adsimple-121612556">Browser und Browserversion</li>
                <li className="adsimple-121612556">das verwendete Betriebssystem</li>
                <li className="adsimple-121612556">die Adresse (URL) der zuvor besuchten Seite (Referrer URL)</li>
                <li className="adsimple-121612556">den Hostname und die IP-Adresse des Geräts von welchem aus
                    zugegriffen wird
                </li>
                <li className="adsimple-121612556">Datum und Uhrzeit</li>
            </ul>
            ...
            <h2 id="cookies" className="adsimple-121612556">Cookies</h2>
            ...
            <h3 className="adsimple-121612556">Was genau sind Cookies?</h3>
            ...
            <p>
                <strong className="adsimple-121612556">Name:</strong> _ga<br/>
                <strong className="adsimple-121612556">Wert:</strong> GA1.2.1326744211.152121612556-9<br/>
                <strong className="adsimple-121612556">Verwendungszweck:</strong> Unterscheidung der
                Webseitenbesucher<br/>
                <strong className="adsimple-121612556">Ablaufdatum:</strong> nach 2 Jahren</p>
            <p>Diese Mindestgrößen sollte ein Browser unterstützen können:</p>
            <ul className="adsimple-121612556">
                <li className="adsimple-121612556">Mindestens 4096 Bytes pro Cookie</li>
                <li className="adsimple-121612556">Mindestens 50 Cookies pro Domain</li>
                <li className="adsimple-121612556">Mindestens 3000 Cookies insgesamt</li>
            </ul>
            <h3 className="adsimple-121612556">Welche Arten von Cookies gibt es?</h3>
            ...
            <p>
                <strong className="adsimple-121612556">Unerlässliche Cookies<br/>
            ...
            <p>
                <strong className="adsimple-121612556">Zweckmäßige Cookies<br/>
                </strong>Diese Cookies sammeln Infos über das Userverhalten und ob der User etwaige Fehlermeldungen
                bekommt. Zudem werden mithilfe dieser Cookies auch die Ladezeit und das Verhalten der Webseite bei
                verschiedenen Browsern gemessen.</p>
            <p>
                <strong className="adsimple-121612556">Zielorientierte Cookies<br/>
            ...
            <p>
                <strong className="adsimple-121612556">Werbe-Cookies<br/>
            ...
            <h3 className="adsimple-121612556">Wie kann ich Cookies löschen?</h3>
            <p>Wie und ob Sie Cookies verwenden wollen, entscheiden Sie selbst. Unabhängig von welchem Service oder
                welcher Webseite die Cookies stammen, haben Sie immer die Möglichkeit Cookies zu löschen, zu
            ...
            <p>Falls Sie grundsätzlich keine Cookies haben wollen, können Sie Ihren Browser so einrichten, dass er Sie
                ...
                Am besten Sie suchen die Anleitung in Google mit dem Suchbegriff “Cookies löschen Chrome” oder “Cookies
                deaktivieren Chrome” im Falle eines Chrome Browsers.</p>
            <h3 className="adsimple-121612556">Wie sieht es mit meinem Datenschutz aus?</h3>
            ...
            <ul className="adsimple-121612556">
                ...
                <li className="adsimple-121612556">Recht auf Löschung („Recht auf Vergessenwerden“) (Artikel 17 DSGVO)
                </li>
                <li className="adsimple-121612556">Recht auf Einschränkung der Verarbeitung (Artikel 18 DSGVO)</li>
                <li className="adsimple-121612556">Recht auf Benachrichtigung – Mitteilungspflicht im Zusammenhang mit
                    der Berichtigung oder Löschung personenbezogener Daten oder der Einschränkung der Verarbeitung
                    (Artikel 19 DSGVO)
                </li>
                <li className="adsimple-121612556">Recht auf Datenübertragbarkeit (Artikel 20 DSGVO)</li>
                <li className="adsimple-121612556">Widerspruchsrecht (Artikel 21 DSGVO)</li>
                <li className="adsimple-121612556">Recht, nicht einer ausschließlich auf einer automatisierten
                    Verarbeitung — einschließlich Profiling — beruhenden Entscheidung unterworfen zu werden (Artikel 22
                    DSGVO)
                </li>
            </ul>
            <p>Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre
                ...
                unter <a className="adsimple-121612556"
                         href="https://www.dsb.gv.at/?tid=121612556">https://www.dsb.gv.at/</a> finden.</p>
            <h2 id="auswertung-des-besucherverhaltens" className="adsimple-121612556">Auswertung des
                Besucherverhaltens</h2>
            ...
            <h2 id="tls-verschluesselung-https" className="adsimple-121612556">TLS-Verschlüsselung mit https</h2>
            ...
            <h2 id="eingebettete-social-media-elemente-datenschutzerklaerung"
                className="adsimple-121612556">Eingebettete Social Media Elemente Datenschutzerklärung</h2>
            <p>Wir binden auf unserer Webseite Elemente von Social Media Diensten ein um Bilder, Videos und Texte
                ...
                diese mit Ihren Daten umgehen:</p>
            <ul className="adsimple-121612556">
            ...
            <h2 id="jquery-cdn-datenschutzerklaerung" className="adsimple-121612556">jQuery CDN
                Datenschutzerklärung</h2>
            <p>Um Ihnen unsere Website bzw. all unsere einzelnen Unterseiten (Webseiten) auf unterschiedlichen Geräten
                schnell und problemlos auszuliefern, nutzen wir Dienste von jQuery CDN des Unternehmens jQuery
                Foundation. jQuery wird über das Content Delivery Network (CDN) des amerikanischen Software-Unternehmens
                StackPath (LCC 2012 McKinney Ave. Suite 1100, Dallas, TX 75201, USA) verteilt. Durch diesen Dienst
                werden personenbezogene Daten von Ihnen gespeichert, verwaltet und verarbeitet.</p>
            ...
            <p>jQuery nutzt JavaScript-Bibliotheken, um unsere Website-Inhalte zügig ausliefern zu können. Dafür lädt
                ein CDN-Server die nötigen Dateien. Sobald eine Verbindung zum CDN-Server aufgebaut ist, wird Ihre
                IP-Adresse erfasst und gespeichert. Das geschieht nur, wenn diese Daten nicht schon durch einen
                vergangenen Websitebesuch in Ihrem Browser gespeichert sind.</p>
            <p>In den Datenschutz-Richtlinien von StackPath wird ausdrücklich erwähnt, dass StackPath aggregierte und
                anonymisierte Daten von diversen Diensten (wie eben auch jQuery) für die Erweiterung der Sicherheit und
